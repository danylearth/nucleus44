...
import { Shield, Copy, Check, Users, Building2, FileText, Dna, Stethoscope, Table } from 'lucide-react';
    ...
    return (
        <div className="p-4 pt-8 space-y-6 max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                ...
                <Link to={createPageUrl('LabResultsTable')} className="block">
                    <Card className="bg-white rounded-2xl border-0 shadow-sm hover:shadow-md transition-shadow">
                        <CardContent className="p-6 flex items-center gap-4">
                            ...
                            <div>
                                <h3 className="font-semibold text-gray-900">All Lab Results Data</h3>
                                <p className="text-sm text-gray-500">View all columns & export CSV</p>
                            </div>
                        </CardContent>
                    </Card>
                </Link>
