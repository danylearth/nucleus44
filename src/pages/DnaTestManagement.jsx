...
export default function DnaTestManagementPage() {
      ...
      <CardContent className="p-4">
        <div className="flex items-start justify-between gap-4">
          ...
          <div className="flex flex-col gap-2">
            <Link to={createPageUrl(`LabResultDetail?id=${result.id}&from=DnaTestManagement`)}>
    ...
    <Card className="bg-white rounded-2xl border-0 shadow-sm">
      <CardContent className="text-center py-12">
        ...
        <p className="text-gray-500 text-sm">
          {status === 'pending' && 'All DNA test results have been reviewed'}
          {status === 'approved' && 'No DNA test results have been approved yet'}
          {status === 'rejected' && 'No DNA test results have been rejected'}
        </p>
      </CardContent>
    </Card>
  );
  ...
  return (
    <div className="bg-gray-50 min-h-screen pb-24">
      ...
      <div className="flex items-center justify-between p-4 pt-12">
        ...
        <h1 className="text-lg font-semibold text-gray-900">DNA Test Management</h1>
        ...
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle className="flex items-center gap-2">
              ...
              Reject DNA Test Result
            </DialogTitle>
            <DialogDescription>
              Please provide a reason for rejecting this DNA test result.
            </DialogDescription>
          </DialogHeader>
          <div className="py-4">
            <Textarea
