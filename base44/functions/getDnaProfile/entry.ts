...
Deno.serve(async (req) => {
    ...
    try {
        ...
        console.log('📊 Fetching DNA profile:', profile_id);

        // Changed to GET request with profile_id in URL
        const muhdoResponse = await fetch(`${MUHDO_BASE_URL}/dna-profile/${profile_id}`, {
            method: 'GET',
            headers: {
        ...
        console.log('✅ DNA profile fetched successfully');
